    ...
    <CardContainer isContainerStyle={true}>
      <section className={styles.mainAboutUs}>
        <div className={styles.wrapper}>
          ...
          <div className={styles.ourMission}>
            <div className={styles.leftText}>
              ...
              <p>
                ...
                players of all ages are sure to love. We through our wider team
                of professionals proudly maintain our values of collaboration
                and integrity. We deliberately support our developers and their
          ...
          <div className={`${styles.ourMission} ${styles.visionSpacer}`}>
            ...
            <div className={`${styles.leftText} ${styles.leftspacer}`}>
              ...
              <p>
                ...
                gaming platform, we are focused to improve the world of fun and
                entertainment. Since inception, Atmegame.com prioritized serving
                gamers without asking their age or gender. This means that
                players can trust us when it comes to seeking unbiased thrill
                and fun.
              </p>
            </div>
          </div>
          ...
          {/* <Image
              src={`${S3_IMAGE_PATH}/img/sign-up-image.svg`}
              width={200}
              height={200}
              alt="Join the fun"
            /> */}
