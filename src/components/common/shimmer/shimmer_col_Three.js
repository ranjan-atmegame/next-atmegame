...
const Shimmer_col_Three = ({ gameTitle }) => {
      ...
      <div className={`${styles.container} ${styles.containerBg}`}>
        ...
        <div className={`${styles.row} ${styles.rowMobile}`}>
              ...
              <div className={styles.cardBody}>
                <div className={styles.gameCard}>
                  <Link href={"#"} className={styles.gameCardImg}>
                    <div
                      className={`${styles.imgwrapper} ${styles.imgFull} ${styles.shine}`}
                    >
                      <Image
                        src={shimmerImgURl}
                        alt="game image"
          ...
          <div className={`${styles.column} ${styles.w33}`}>
            <div className={`${styles.card} ${styles.noShadow}`}>
              <div className={styles.cardBody}>
                <div className={`${styles.gameCard} ${styles.gameTwo}`}>
                  <Link href={"#"} className={styles.gameCardImg}>
...
export default Shimmer_col_Three;
